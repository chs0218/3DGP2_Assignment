...
public:
	...
	virtual void CreateShader(ID3D12Device* pd3dDevice, ID3D12RootSignature* pd3dGraphicsRootSignature, UINT nRenderTargets, DXGI_FORMAT* pdxgiRtvFormats);
...
public:
	CTexture* GetTexture();
	ID3D12Resource* GetTextureResource(UINT nIndex);
